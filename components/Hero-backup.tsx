      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", textAlign: "center", position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ position: "absolute", inset: "16px", background: "linear-gradient(135deg, #1f2937, #111827)", borderRadius: "50%", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
